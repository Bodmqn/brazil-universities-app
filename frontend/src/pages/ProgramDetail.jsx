...
function Field({ label, value, href }) {
  ...
  return (
    <div className="py-2">
      ...
      {href ? (
        <a href={href} target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline font-medium break-all">
          {value}
        </a>
      ) : (
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            ...
            <p className="text-gray-500">
              <Link to={`/universities/${uni.id}`} className="text-green-700 hover:underline">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <Field label="Master's Required for PhD" value={prog.master_required === 'SIM' ? 'Yes' : prog.master_required ? prog.master_required : 'No'} />
          </div>
          <div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        ...
        {prog.scan_last_checked ? (
          <div className="space-y-2 text-sm">
            <div>
              <span className="text-gray-500">Last checked: </span>
              <span className="text-gray-900">{new Date(prog.scan_last_checked).toLocaleString()}</span>
            </div>
            <div>
            ...
            {prog.scan_title && (
              <div>
                ...
                <span className="text-gray-900">{prog.scan_title}</span>
              </div>
            )}
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="mt-4">
          <Link to={`/universities/${uni.id}`} className="text-sm text-green-700 hover:underline">
